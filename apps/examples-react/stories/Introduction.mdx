import { createStackblitz } from '@veavr/stackblitz-creator'

<div style={{ height: '60vw', display: 'flex', alignItems: 'stretch' }}>
  <div id="stackblitz_host0" />
</div>
<button onClick={() => createStackblitz('stackblitz_host0')}>
  Open Stackblitz
</button>
<div style={{ height: '60vw', display: 'flex', alignItems: 'stretch' }}>
  <div id="stackblitz_host1" />
</div>
<button onClick={() => createStackblitz('stackblitz_host1')}>
  Open Stackblitz
</button>
<div style={{ height: '60vw', display: 'flex', alignItems: 'stretch' }}>
  <div id="stackblitz_host2" />
</div>
<button onClick={() => createStackblitz('stackblitz_host2')}>
  Open Stackblitz
</button>
...
veavr is a library to help you build highly customizable ui components featuring tight integration with TypeScript.
