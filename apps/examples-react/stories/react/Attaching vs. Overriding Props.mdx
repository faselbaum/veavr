...
This section focuses on the most basic feature of veavr components -
attaching and overriding props directly on site using the `$vvr` prop.
...
By using the `$vvr.attach` property you can assign properties to parts
...
The `$vvr.override` property does exactly what the name implies.
