...
import cardComponentCode from '../../../../../packages/weavr-react-components/src/components/card-weave-parts.tsx?raw'

# Advanced - Swapping Parts

weavr components allow you to swap out internal parts.
