...
import cardComponentCode from '../../../../../packages/weavr-react-components/src/components/card-weave-state.tsx?raw'
...
This can be achieved through facilitating weavr's `.bindState()` function.
